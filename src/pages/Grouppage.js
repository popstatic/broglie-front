                        ...
                        <div className="middle-sidebar-left pe-0">
                            <div className="row">
                                ...
                                <div className="col-xl-8 col-xxl-9 col-lg-8 mt-3">
                                    <Createpost />
                                    <Postview id="32" postvideo="" postimage="post.png" avater="user.png" user="Henry de Boisseguin" time="22 min ago" des="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor, ornare at commodo non, feugiat non nisi. Phasellus faucibus mollis pharetra. Proin blandit ac massa sed rhoncus." />
